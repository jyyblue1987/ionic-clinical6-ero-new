...
let SoftKeyboardService = class SoftKeyboardService {
    constructor() {
...
SoftKeyboardService = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [])
], SoftKeyboardService);
export { SoftKeyboardService };

//# sourceMappingURL=soft-keyboard.service.js.map
